package main.java.com.shesel.airportbaggagerouting.model;
...
public class Vertex implements Comparable<Vertex> {
	...
	private int time = Integer.MAX_VALUE; // Will be the total time for the
											// shortest path to this Vertex from
											// the source Vertex specfied in the
											// DijkstraGraphMap
	private Vertex prevVertext = null;
	private final Map<Vertex, Integer> neighbours = new HashMap<>(); // The
																		// neighbour
																		// Vertex
																		// and
																		// the
